...
const Login = props => {
  ...
  document.title = "Login | Qadar spiritual app";
  return (
    <React.Fragment>
                ...
                <div className="bg-primary">
                  <div className="text-primary text-center p-4">
                    ...
                    <p className="text-white-50">
                      {!showForgot && t('Sign in to continue to Qadar spiritual app admin')}
                    </p>
                    <Link to="/" className="logo logo-admin">
                      <img src={logoSm}  alt="logo" style={{objectFit:"contain",borderRadius:"50%"}} width="75px"/>
                    </Link>
                  </div>
                </div>
