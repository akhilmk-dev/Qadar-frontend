...
import { fetchPlansRequest, fetchRedeemPlansRequest} from "store/actions";
...
const ReedemPlanDataTable = ({
    ...
    useEffect(() => {
        ...
        dispatch(fetchRedeemPlansRequest(params));
...
export default ReedemPlanDataTable;
