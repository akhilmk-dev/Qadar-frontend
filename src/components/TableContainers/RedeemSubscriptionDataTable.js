...
import { fetchRedeemSubscriptionsRequest, fetchRewardsRequest, fetchSubscriptionsRequest } from "store/actions";


// Global Filter (Debounced Input)

const RedeemSubscriptionDataTable = ({
    columns,
    data,
    tableClass,
    isPagination = true,
    ...
    useEffect(() => {
        ...
        dispatch(fetchRedeemSubscriptionsRequest(params));
...
export default RedeemSubscriptionDataTable;
