...
import { fetchCategoryPlansRequest } from "store/actions";
...
const CategoryPlanDataTable = ({
    ...
    useEffect(() => {
        ...
        dispatch(fetchCategoryPlansRequest(params));
...
export default CategoryPlanDataTable;
