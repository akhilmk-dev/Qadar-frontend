...
import { fetchMoodsRequest, fetchUsersRequest, getClassifications, getEvents } from "store/actions";
...
const UserTokenDataTable = ({
    ...
    useEffect(() => {
        ...
        dispatch(fetchUserTokensRequest(params));
...
export default UserTokenDataTable;
