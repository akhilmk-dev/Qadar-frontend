...
import { fetchAffirmationsRequest } from "store/actions";
...
const AffirmationDataTable = ({
    ...
    useEffect(() => {
        ...
        dispatch(fetchAffirmationsRequest(params));
...
export default AffirmationDataTable;
