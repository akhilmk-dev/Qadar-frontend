...
import { fetchPaymentLogsRequest, fetchUsersRequest, getClassifications, getEvents } from "store/actions";
...
const PaymentLogDataTable = ({
    ...
    useEffect(() => {
        ...
        dispatch(fetchPaymentLogsRequest(params));
...
export default PaymentLogDataTable;
